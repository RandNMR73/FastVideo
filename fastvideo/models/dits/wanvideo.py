...
class WanSelfAttention(nn.Module):
    ...
    def __init__(self,
        ...
        if quant_config is not None and not hasattr(self.to_q, '_fp8_weight'):
        ...
        if quant_config is not None and not hasattr(self.to_k, '_fp8_weight'):
        ...
        if quant_config is not None and not hasattr(self.to_v, '_fp8_weight'):
        ...
        if quant_config is not None and not hasattr(self.to_out, '_fp8_weight'):
...
class WanI2VCrossAttention(WanSelfAttention):
    ...
    def __init__(
        ...
        if quant_config is not None and not hasattr(self.add_k_proj, '_fp8_weight'):
        ...
        if quant_config is not None and not hasattr(self.add_v_proj, '_fp8_weight'):
...
class WanTransformerBlock_VSA(nn.Module):
    ...
    def __init__(self,
        ...
        if quant_config is not None and not hasattr(self.to_gate_compress, '_fp8_weight'):
