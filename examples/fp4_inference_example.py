#!/usr/bin/env python3
"""
Example script showing how to use FP4 quantization for inference with existing models.

This script demonstrates how to generate videos using FP4 quantization for improved
memory efficiency and faster inference on supported hardware (H100+).

Usage:
    python examples/fp4_inference_example.py
"""
...
def main():
    ...
    # Create VideoGenerator with FP4-compatible settings
    ...
    # Generate video with FP4 quantization
